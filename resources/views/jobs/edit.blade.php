<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{route('jobs.update', $job->id)}}" enctype="multipart/form-data">
            ...
            <x-form.select id="job_type" name="job_type" label="Job Type" :value="old('job_type', $job->job_type)"
            ...
            <x-form.text id="city" name="city" label="City" placeholder="Albany" :value="old('city', $job->city)" />

            <x-form.text id="state" name="state" label="State" placeholder="NY" :value="old('state', $job->state)" />
            ...
            <x-form.text id="company_website" name="company_website" label="Company Website" type="url"
            ...
            <button type="submit"
                    class="cursor-pointer w-full bg-green-500 hover:bg-green-600 text-white px-4 py-2 my-3 rounded focus:outline-none">
                Save
            </button>
        </form>
    </div>
